...
from populate_resorts import ResortValidator, ResortPopulator
...
class TestRegionMappings:
    ...
    def test_all_regions_have_countries(self):
        ...
        skiing_countries = ["US", "CA", "FR", "CH", "AT", "IT", "JP", "AU", "NZ", "CL", "AR"]
    ...
    def test_canadian_provinces_have_regions(self):
        ...
        for province in skiing_provinces:
            assert province in CA_PROVINCE_REGIONS, f"Missing CA province mapping for {province}"
