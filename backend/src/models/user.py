...
class UserPreferences(BaseModel):
    ...
    favorite_resorts: List[str] = Field(default_factory=list, description="List of favorite resort IDs")
    ...
    created_at: str = Field(..., description="ISO timestamp when preferences were created")
    updated_at: str = Field(..., description="ISO timestamp when preferences were last updated")
