...
SYSTEM_PROMPT = (
    ...
    "- **EXCELLENT** (85-100): Deep fresh powder, cold temps, no thaw-freeze. Dream skiing.\n"
    "- **GOOD** (65-84): Good non-refrozen coverage, stable cold temps. Great day out.\n"
    "- **FAIR** (45-64): Some fresh snow on older base, may have thin crust. Decent skiing.\n"
    "- **POOR** (30-44): Limited fresh snow, harder surface with some soft spots.\n"
    "- **BAD** (15-29): Icy/refrozen surface, no fresh snow covering ice layer.\n"
    "- **HORRIBLE** (0-14): Not skiable — no snow, melting, or dangerous.\n\n"
