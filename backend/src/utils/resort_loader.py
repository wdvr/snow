...
class ResortLoader:
    ...
    def _transform_resort(self, raw: dict[str, Any], now: str) -> Resort:
        ...
        return Resort(
            ...
            double_black_runs_pct=raw.get("double_black_runs_pct"),
            has_snowmaking=raw.get("has_snowmaking"),
            day_ticket_price_min_usd=raw.get("day_ticket_price_min_usd"),
            day_ticket_price_max_usd=raw.get("day_ticket_price_max_usd"),
            annual_snowfall_cm=raw.get("annual_snowfall_cm"),
            epic_pass=raw.get("epic_pass"),
            ikon_pass=raw.get("ikon_pass"),
            mountain_collective=raw.get("mountain_collective"),
            indy_pass=raw.get("indy_pass"),
            family_friendly=raw.get("family_friendly"),
            expert_terrain=raw.get("expert_terrain"),
            large_resort=raw.get("large_resort"),
            ski_in_out=raw.get("ski_in_out"),
