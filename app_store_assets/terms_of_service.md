...
### 1.2 Updates
We may modify these Terms at any time. We will notify you of material changes through the App or other reasonable means. Your continued use after changes constitutes acceptance of the updated Terms.
...
- Personalization features (favorites, preferences)
- Offline access to cached data

### 2.2 Data Sources
Information is sourced from:
- Public weather APIs and government meteorological services
- Ski resort official weather stations and reports
- Third-party weather data providers

## 3. User Accounts and Registration

### 3.1 Optional Registration
- Account creation is optional; core features work without signing in
- You may sign in with Apple ID or Google account for personalization
...
- Share resort conditions with friends through built-in sharing features
- Provide feedback to help improve the App

### 4.2 Prohibited Activities
You may not:
- Use the App for illegal activities or to violate any laws
...
- Weather data is provided "as is" from third-party sources
- We strive for accuracy but cannot guarantee complete precision
- Conditions can change rapidly and unexpectedly
- Always verify conditions with local authorities before outdoor activities
...
- Weather conditions can be dangerous and change without notice

### 5.3 No Liability for Conditions
We are not responsible for:
- Inaccurate weather predictions or data
- Decisions you make based on App information
- Changes in actual conditions versus reported conditions
- Accidents or injuries related to weather or snow conditions

## 6. Privacy and Data

### 6.1 Privacy Policy
Your privacy is important to us. Our Privacy Policy explains how we collect, use, and protect your information. By using the App, you also agree to our Privacy Policy.

### 6.2 Location Data
- Location access is optional and can be disabled
- Used only to show nearby resorts when enabled
- We do not track your precise movements or store location history
...
- Weather data belongs to respective providers
- Resort information may be sourced from public APIs
- We respect third-party intellectual property rights

### 7.3 User Content
By providing feedback or suggestions:
- You grant us a non-exclusive license to use your input
- You confirm you own the rights to any content you provide
- We may use feedback to improve the App without compensation
...
### 8.2 Weather Data Disclaimer
- Weather information may be inaccurate, incomplete, or outdated
- We do not warrant the reliability of third-party data sources
- Always consult multiple sources for critical weather decisions
...
- DAMAGES RESULTING FROM WEATHER-RELATED DECISIONS

### 9.2 Maximum Liability
Our total liability for any claim shall not exceed the amount you paid for the App (which is $0 for free users).

### 9.3 Essential Terms
These limitations are fundamental to our agreement and will apply even if remedies fail their essential purpose.
...
- Cached data may remain on your device until manually deleted
- Provisions that should survive (privacy, limitations, etc.) continue to apply

## 12. Geographic Restrictions

### 12.1 Availability
- The App is intended for worldwide use
- Some features may not be available in all regions
- We make no representation that the App is appropriate for use in all jurisdictions

### 12.2 Export Controls
You agree not to export or re-export the App in violation of applicable laws.

## 13. Dispute Resolution

### 13.1 Governing Law
These Terms are governed by the laws of Canada and the Province of British Columbia, without regard to conflict of law principles.
...
Snow sports involve inherent risks. Always:
- Check current conditions with local authorities
